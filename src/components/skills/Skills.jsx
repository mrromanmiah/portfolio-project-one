    ...
    return (
        <div className="bg-[#91ff00] bg-opacity-10 py-14">
            <div className="lg:mx-40 md:mx-20 mx-10 ">
                <div>
                    <h1 className="text-3xl text-[#91ff00] font-bold text-center">My Skills</h1>
                    <p className="text-white text-sm text-center pt-5 w-1/2 mx-auto">Elevating Web Experiences with Proficient Development Skills</p>
                </div>

                <div className="mt-10 grid lg:grid-cols-6 md:grid-cols-4 grid-cols-2 lg:gap-10 md:gap-10 gap-5">
